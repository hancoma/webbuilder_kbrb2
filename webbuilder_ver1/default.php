...
<head>
    ...
    <!-- Global CSS -->
    <link rel="stylesheet" href="<?=$g['dir_layout']?>/plugins/bootstrap/css/bootstrap.min.css">   
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="<?=$g['dir_layout']?>/plugins/font-awesome/css/font-awesome.css">
    <!-- github acitivity css -->
    <link rel="stylesheet" href="<?=$g['dir_layout']?>/plugins/github-activity/dist/github-activity-0.1.1.min.css">
    <link rel="stylesheet" href="<?=$g['dir_layout']?>/plugins/github-activity/dist/octicons/octicons.min.css">
    
    
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="<?=$g['dir_layout']?>/css/styles.css">
...
<body>
    ...
    <header class="header">
        <div class="container">                       
            <img class="profile-image img-responsive pull-left" src="<?=$g['dir_layout']?>/images/profile.png" alt="James Lee" />
            <div class="profile-content pull-left">
                <h1 class="name">Webbuilder</h1>
                <h2 class="desc">homepage builder</h2>   
